...
const Footer = () => {
    return (
        <div className="bg-[#28313C] mt-10 pt-10 pb-5 flex justify-center flex-col">
            ...
            <p className="opacity-60 w-10/12 mx-auto">Employers & Recruiters stay up to date with the latest coupon or voucher updates & announcements</p>
            <div className="relative w-10/12 mx-auto md:w-96 mt-5">
            <input type="email" placeholder="type your e-mail here..." className="min-w-42 w- p-2 px-4 w-full rounded-full text-black outline-none"/>
            <button className="absolute btn right-2 top-1 rounded-full px-6 bg-red-500 border-0 font-bold btn-sm hover:bg-red-700  text-white">Join</button>
            </div>
