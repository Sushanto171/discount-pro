               ...
               <div className="absolute -top-16 md:-top-20 rounded-full p-2 bg-white">
                ...
                <div className=" col-span-2 border min-h-40 p-5 rounded-lg bg-blue-50 ">
                    <div className="flex justify-end mb-3">
                        <button onClick={updateBtnHandler} className="btn btn-sm btn-outline hover:border-sky-400 hover:text-sky-400 hover:bg-transparent rounded-none">{profileUpdateField ?<> <LiaUserEditSolid size={20} /> Update Profile</> :<><MdOutlineManageAccounts size={20} /> Back to Profile</>}</button>
                    </div>

              { profileUpdateField && <div className="space-y-3">
                <p><span className="font-bold text-xl">{displayName || "Unknown person"}</span></p>
            ...
            {/* Social */}
                <div className="border p-5 rounded-md mt-5 sm:mt-0 bg-blue-50">
                    ...
                    <div className="flex items-center justify-center gap-8 my-5">
                        <button><FaFacebook size={20} /></button>
